    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
      ...
      >
        ...
        <div style={{ position: 'absolute', bottom: -60, right: 60, width: 140, height: 140,
          background: 'rgba(31,107,58,0.15)', borderRadius: '50%' }}/>
        ...
        >
          ...
          <div style={{ position: 'relative', marginBottom: 10 }}>
            ...
            >
              <motion.div
                initial={{ width: 0 }}
                animate={{ width: `${Math.min(100, (xp / TOTAL_XP) * 100)}%` }}
            ...
            {/* Grade milestones */}
            {[{ label: 'P', value: PASS_XP }, { label: 'M', value: PASS_MERIT_XP }, { label: 'D', value: TOTAL_XP }].map(
              milestone => {
                const left = `${Math.min(100, (milestone.value / TOTAL_XP) * 100)}%`
                return (
                  <div
                    key={milestone.label}
                    style={{
      ...
      {tutorNote && (
        <motion.div
          ...
          style={{
            background: '#fffbeb',
            border: '1.5px solid var(--merit-mid)',
            borderRadius: 12,
            padding: '14px 18px',
            display: 'flex',
            gap: 10,
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(240px,1fr))', gap: 16 }}>
        ...
        {nextSec && (
          <motion.div initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }}
            ...
            style={{ background: 'var(--white)', borderRadius: 12, padding: '20px',
            ...
            {(() => { const c = CRIT_COLORS[nextSec.criteria]
              return <span style={{ display: 'inline-block', fontSize: 11, fontWeight: 700,
            ...
            <div style={{ marginTop: 8, fontFamily: 'var(--font-mono)', fontSize: 11,
              color: 'var(--pass)', fontWeight: 700 }}>+{nextSec.xp} XP →</div>
          </motion.div>
        )}
